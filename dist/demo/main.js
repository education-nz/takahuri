...
/* harmony import */ var _takahuri__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../takahuri */ "./src/takahuri.js");



var initialiseJSUtilities = function initialiseJSUtilities() {
  var body = document.getElementsByTagName('body')[0];
  body.classList.remove('no-js');
  body.classList.add('js');
  Object(_takahuri__WEBPACK_IMPORTED_MODULE_1__["default"])();
};
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getKeypressHandler", function() { return getKeypressHandler; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "attachKeyListeners", function() { return attachKeyListeners; });
...
var attachListeners = function attachListeners(config, element, action) {
  var events = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : null;
  var e = events || config.events.click;
...
var getKeypressHandler = function getKeypressHandler(config, action) {
...
var getLanguageValue = function getLanguageValue(config, lang, element, attribute) {
  var langOptionsPrefix = config.identifiers.langOptionsPrefix;
  var prefix = attribute.startsWith(langOptionsPrefix) ? '' : langOptionsPrefix;
  var key = lang === config.langKey.a ? "".concat(prefix).concat(attribute, "-").concat(config.langKey.a) : "".concat(prefix).concat(attribute, "-").concat(config.langKey.b);
  return element.getAttribute(key);
};

var commaSeparatedAttributeArray = function commaSeparatedAttributeArray(attributes) {
  return attributes.split(',');
};

var updateAttribute = function updateAttribute(config, lang) {
  return function (element) {
    var attributes = commaSeparatedAttributeArray(element.getAttribute(config.identifiers.flag));
    attributes.forEach(function (attribute) {
      var updatedValue = getLanguageValue(config, lang, element, attribute);
...
var saveToLocalStorage = function saveToLocalStorage(config, value) {
  localStorage.setItem(config.storageKey, value);
};

var getFromLocalStorage = function getFromLocalStorage(config) {
...
var toggleLanguageInLocalStorage = function toggleLanguageInLocalStorage(config) {
  var toggledValue = getToggledValue(config);
  saveToLocalStorage(config, toggledValue);
  return toggledValue;
};

var updateLanguage = function updateLanguage(config, newLanguage) {
...
var setLanguage = function setLanguage(config) {
...
var toggleLanguage = function toggleLanguage(config) {
  return function () {
    ...
    var lang = toggleLanguageInLocalStorage(config);
...
var getUrlParam = function getUrlParam(config) {
...
var loadInitialState = function loadInitialState(config) {
  var urlValue = getUrlParam(config);
  var initialValue = urlValue || getFromLocalStorage(config) || config.defaultLang;
...
var mergeConfigs = function mergeConfigs(customConfig) {
  return _objectSpread({}, DEFAULT_CONFIG, customConfig);
};
/**
 * Public interface
 */
...
var initLanguageToggle = function initLanguageToggle(customConfig) {
  // attach toggle on load
  var config = mergeConfigs(customConfig);
  var toggleFunction = toggleLanguage(config);
...
/***/ 0:
/*!*****************************************************!*\
  !*** multi ./src/demo/main.js ./src/demo/main.scss ***!
  \*****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
